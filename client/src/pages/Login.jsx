        ...
        <div className="flex items-center justify-center min-h-screen relative overflow-hidden">
            ...
            <div className="w-full max-w-md p-4 relative z-10">
                <div className="text-center mb-8 space-y-2">
                    <div className="inline-flex items-center justify-center w-12 h-12 rounded-xl bg-gradient-to-tr from-indigo-500 to-emerald-500 text-white shadow-lg shadow-indigo-500/25 mb-4">
                        <span className="font-bold text-xl">S</span>
                    </div>
                    <h1 className="text-3xl font-bold tracking-tight text-white">Welcome back</h1>
                    <p className="text-gray-400 text-sm">Enter your credentials to access your finance</p>
                </div>
                ...
                <div className="glass-card rounded-2xl p-1 border border-white/10">
                    <div className="bg-gray-950/50 rounded-xl p-6 sm:p-8 backdrop-blur-sm">
                        <form onSubmit={handleSubmit} className="space-y-5">
                            ...
                            <Button
                                type="submit"
                                className="w-full bg-gradient-to-r from-indigo-600 to-indigo-500 hover:from-indigo-500 hover:to-indigo-400 text-white font-medium h-11 shadow-lg shadow-indigo-500/20 transition-all active:scale-[0.98]"
                                disabled={isLoading}
                            >
                                {isLoading ? (
                        ...
                        <div className="mt-6 text-center">
                            <p className="text-sm text-gray-500">
                                ...
                                <Link to="/register" className="text-indigo-400 hover:text-indigo-300 font-medium hover:underline decoration-indigo-400/30 transition-colors">
                                    Create account
                                </Link>
                            </p>
                        </div>
